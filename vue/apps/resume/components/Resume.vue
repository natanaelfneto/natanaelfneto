        ...
        <div class="mx-lg-5 px-md-5">
            <div
                ...
                <div class="row mt-4 mt-md-0">
                    ...
                    <div class="offset-1 col-10 p-2 m-auto">
                        <p class="card-text mb-auto">
                            <component :is="fieldset.title.replace(' ','')" :data="data"></component>
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    import Jumbotron from './Resume/Jumbotron.vue'
    import Sumary from './Resume/Sumary.vue'
    import AcademicFormation from './Resume/AcademicFormation.vue'
